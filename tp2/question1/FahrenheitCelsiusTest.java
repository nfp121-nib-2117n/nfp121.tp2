...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test_fahrenheitEnCelsius() {
        ...
        assertEquals("   625 °F -> 329.4 °C ?", 329.4, question1.FahrenheitCelsius.fahrenheitEnCelsius(625), 0.1);
        assertEquals("   5 °F -> -15.0 °C ?", -15.0, question1.FahrenheitCelsius.fahrenheitEnCelsius(5), 0.1);
        assertEquals("   2555 °F -> 1401.6 °C ?", 1401.6, question1.FahrenheitCelsius.fahrenheitEnCelsius(2555), 0.1);
    }
